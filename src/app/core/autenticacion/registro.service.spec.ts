...
describe('RegistroService', () => {
  ...
  beforeEach(() => {
    ...
    mockFirebaseRegistroAdapterService = jasmine.createSpyObj(
      'FirebaseRegistroServiceAdapterService',
      ['firebaseCreateUserWithEmailAndPassword', 'firebaseSetUserDocument']
    );
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        {
          provide: FirebaseRegistroServiceAdapterService,
          useValue: mockFirebaseRegistroAdapterService,
        },
      ],
    });
  ...
  describe('registrarUsuario', () => {
    ...
    beforeEach(() => {
      ...
      mockFirebaseRegistroAdapterService.firebaseCreateUserWithEmailAndPassword.and.resolveTo(
        mockUserCredential as unknown as UserCredential
      ); // Cast a any para evitar problemas de tipos
    ...
    it('should call firebaseCreateUserWithEmailAndPassword with correct credentials', async () => {
      await service.registrarUsuario(testEmail, testPassword, testNombre);
      expect(
        mockFirebaseRegistroAdapterService.firebaseCreateUserWithEmailAndPassword
    ...
    it('should call firebaseSetUserDocument with correct user data', async () => {
      ...
      expect(
        mockFirebaseRegistroAdapterService.firebaseSetUserDocument
      ).toHaveBeenCalledWith(
        mockUserCredential.user.uid,
        jasmine.objectContaining({
          // Usa objectContaining para comparar solo las propiedades importantes
    ...
    it('should handle errors during user creation', async () => {
      ...
      mockFirebaseRegistroAdapterService.firebaseCreateUserWithEmailAndPassword.and.rejectWith(
        authError
      );

      await expectAsync(
        service.registrarUsuario(testEmail, testPassword, testNombre)
    ...
    it('should handle errors during setting user document', async () => {
      ...
      mockFirebaseRegistroAdapterService.firebaseSetUserDocument.and.rejectWith(
        firestoreError
      );
